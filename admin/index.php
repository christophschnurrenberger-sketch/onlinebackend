...
{
    if ($vorher === 0) {
        return '<div class="bk-zahl-diff bk-neben">kein Vorzeitraum</div>';
    }
    $prozent = (int) round((($jetzt - $vorher) / $vorher) * 100);
    $klasse  = $prozent >= 0 ? 'bk-hoch' : 'bk-runter';
    return '<div class="bk-zahl-diff ' . $klasse . '">' . ($prozent >= 0 ? '▲' : '▼') . ' '
...
<div class="bk-seitenkopf">
  <div class="bk-titel">
    <h1>Übersicht</h1>
    <div class="bk-untertitel">Letzte <?= (int) $tage ?> Tage</div>
  </div>
  <div class="bk-aktionen">
    <form method="get">
      ...
      <noscript><button class="bk-knopf bk-knopf-klein" type="submit">Zeitraum</button></noscript>
    </form>
...
<div class="bk-vier" style="margin-bottom:16px">
  <div class="bk-zahl">
    <div class="bk-zahl-titel">Umsatz</div>
    <div class="bk-zahl-wert"><?= Util::e(Util::geld($zahlen['umsatz'])) ?></div>
  ...
  <div class="bk-zahl">
    ...
    <div class="bk-zahl-wert"><?= (int) $zahlen['anzahl'] ?></div>
    <?= veraenderung($zahlen['anzahl'], $zahlen['anzahl_vorher']) ?>
  </div>
  <div class="bk-zahl">
    <div class="bk-zahl-titel">Ø Bestellwert</div>
    <div class="bk-zahl-wert"><?= Util::e(Util::geld($zahlen['schnitt'])) ?></div>
  </div>
  <div class="bk-zahl">
    <div class="bk-zahl-titel">Zu erledigen</div>
    <div class="bk-zahl-wert"><?= (int) $zahlen['unversendet'] ?></div>
    <div class="bk-zahl-diff bk-neben"><?= (int) $zahlen['unbezahlt'] ?> unbezahlt · <?= (int) $zahlen['offen'] ?> offen</div>
  </div>
</div>
...
<div class="bk-zwei">
  <section class="bk-karte">
    <div class="bk-karte-kopf">
      ...
      <a class="bk-knopf bk-knopf-klein" href="bestellungen.php">Alle ansehen</a>
    </div>
    <div class="bk-karte-inhalt eng">
      ...
      <?php else: ?>
        <div class="bk-tabelle-rahmen"><table>
          <thead><tr><th>Nr.</th><th>Kunde</th><th>Zahlung</th><th class="bk-zahl-rechts">Summe</th><th>Zeit</th></tr></thead>
          <tbody>
            <?php foreach ($letzte as $bestellung): ?>
              <?php $a = $bestellung['lieferadresse_daten']; ?>
              <tr class="bk-klick" onclick="location='bestellung.php?id=<?= (int) $bestellung['id'] ?>'">
                ...
                <td class="bk-neben"><?= Util::e(Util::seit((string) $bestellung['erstellt'])) ?></td>
              </tr>
            <?php endforeach; ?>
          </tbody>
        </table></div>
  ...
  <div>
    <section class="bk-karte">
      <div class="bk-karte-kopf"><h2>Katalog</h2></div>
    ...
    <section class="bk-karte">
      <div class="bk-karte-kopf"><h2>Bestand wird knapp</h2></div>
      <div class="bk-karte-inhalt eng">
        <?php if ($knapp === []): ?>
          <div class="bk-leer" style="padding:24px"><p>Alle Bestände sind in Ordnung.</p></div>
        <?php else: ?>
          <div class="bk-tabelle-rahmen"><table><tbody>
            <?php foreach ($knapp as $eintrag): ?>
              <tr class="bk-klick" onclick="location='artikel-bearbeiten.php?id=<?= (int) $eintrag['artikel_id'] ?>'">
                <td>
                  <div class="bk-haupt"><?= Util::e((string) $eintrag['artikel']) ?></div>
                  <div class="bk-neben"><?= Util::e((string) $eintrag['variante']) ?><?php
                ...
                <td class="bk-zahl-rechts">
                  <span class="bk-marke <?= (int) $eintrag['bestand'] <= 0 ? 'bk-marke-rot' : 'bk-marke-gelb' ?>">
    ...
    <?php if ($zahlen['top_artikel'] !== []): ?>
      <section class="bk-karte">
        <div class="bk-karte-kopf"><h2>Meistverkauft</h2></div>
        <div class="bk-karte-inhalt eng">
          <div class="bk-tabelle-rahmen"><table><tbody>
            <?php foreach ($zahlen['top_artikel'] as $artikel): ?>
              <tr>
                <td><?= Util::e((string) $artikel['titel']) ?>
                  <div class="bk-neben"><?= (int) $artikel['menge'] ?> verkauft</div></td>
                <td class="bk-zahl-rechts"><?= Util::e(Util::geld((int) $artikel['umsatz'])) ?></td>
              </tr>
            <?php endforeach; ?>
          </tbody></table></div>
        </div>
