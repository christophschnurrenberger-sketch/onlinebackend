...
<?php elseif ($offen['anzahl'] === 0): ?>
  <div class="bk-hinweis bk-hinweis-erfolg">
...
<div class="bk-zwei">
  <form method="post" class="bk-karte">
    ...
    <div class="bk-karte-inhalt">
      <?php if ($offen['nie']): ?>
        <p class="bk-tipp">Der gesamte aktuelle Stand geht mit dem ersten Veröffentlichen live.</p>
      <?php elseif ($offen['liste'] === []): ?>
        <p class="bk-tipp">Seit der letzten Veröffentlichung wurde nichts geändert.</p>
      <?php else: ?>
        <ul class="bk-aenderungen">
          <?php foreach ($offen['liste'] as $aenderung): ?>
            <li>
              <span class="bk-art bk-art-<?= Util::e((string) $aenderung['art']) ?>">
                <?= Util::e($artNamen[(string) $aenderung['art']] ?? (string) $aenderung['art']) ?>
              </span>
              <span class="bk-neben"><?= Util::e((string) $aenderung['typ']) ?></span>
      ...
      <div class="bk-feld" style="margin-top:16px">
        ...
        <div class="bk-tipp">Hilft später im Verlauf, die richtige Fassung wiederzufinden.</div>
      </div>
    </div>
    <div class="bk-karte-fuss">
      <button class="bk-knopf bk-knopf-gruen" type="submit" <?= $kannVeroeffentlichen ? '' : 'disabled' ?>>
  ...
  <section class="bk-karte">
    ...
    <div class="bk-karte-inhalt eng">
      <?php if ($fassungen === []): ?>
        <div class="bk-leer" style="padding:24px"><p>Noch keine Veröffentlichung.</p></div>
      <?php else: ?>
              ...
              <tr>
                <td>
                  ...
                  <?php if ((int) $fassung['live'] === 1): ?>
                    <div><span class="bk-marke bk-marke-gruen"><i></i>live</span></div>
                  <?php endif; ?>
                </td>
                <td class="bk-neben">
                ...
                <td class="bk-neben" title="<?= Util::e(Util::dt((string) $fassung['erstellt'])) ?>">
                ...
                <td class="bk-zahl-rechts">
                  <?php if ((int) $fassung['live'] !== 1 && Auth::darf('einstellen')): ?>
                    <form method="post" style="display:inline"
                      ...
                      <button class="bk-knopf bk-knopf-klein" type="submit">Zurücksetzen</button>
                    </form>
                  <?php endif; ?>
                </td>
              </tr>
