...
<form method="post">
  ...
  <div class="bk-feldzeile">
    <div class="bk-feld"><label for="shop_name">Shopname</label>
      <input type="text" id="shop_name" name="shop_name" required value="<?= Util::e($e('shop_name')) ?>"></div>
    <div class="bk-feld"><label for="shop_slogan">Slogan</label>
  ...
  <div class="bk-feld">
    ...
    <div class="bk-tipp">Erscheint als Standardbeschreibung bei Suchmaschinen und beim Teilen.</div>
  </div>
  <div class="bk-feldzeile">
    <div class="bk-feld"><label for="shop_email">E-Mail</label>
      <input type="email" id="shop_email" name="shop_email" value="<?= Util::e($e('shop_email')) ?>"></div>
    <div class="bk-feld"><label for="shop_telefon">Telefon</label>
  ...
  <div class="bk-feldzeile">
    <div class="bk-feld"><label for="logo_url">Logo (Adresse)</label>
      <input type="text" id="logo_url" name="logo_url" value="<?= Util::e($e('logo_url')) ?>" placeholder="uploads/logo.png"></div>
    <div class="bk-feld"><label for="favicon_url">Favicon (Adresse)</label>
  ...
  <div class="bk-feld"><label for="strasse">Straße und Hausnummer</label>
    <input type="text" id="strasse" name="strasse" value="<?= Util::e($e('strasse')) ?>"></div>
  <div class="bk-feldzeile">
    <div class="bk-feld"><label for="plz">PLZ</label>
      <input type="text" id="plz" name="plz" value="<?= Util::e($e('plz')) ?>"></div>
    <div class="bk-feld"><label for="ort">Ort</label>
  ...
  <div class="bk-hinweis bk-hinweis-info" style="margin:0 0 14px">
  ...
  <div class="bk-feldzeile">
    <div class="bk-feld"><label for="siegel_url">Siegel: Prüflink</label>
      <input type="url" id="siegel_url" name="siegel_url" value="<?= Util::e($e('siegel_url')) ?>"
             placeholder="https://…"></div>
    <div class="bk-feld"><label for="siegel_text">Siegel: Beschriftung</label>
  ...
  <div class="bk-feldzeile">
    <div class="bk-feld"><label for="social_instagram">Instagram</label>
      <input type="url" id="social_instagram" name="social_instagram" value="<?= Util::e($e('social_instagram')) ?>"></div>
    <div class="bk-feld"><label for="social_facebook">Facebook</label>
