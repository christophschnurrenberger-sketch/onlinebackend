...
if ($maske) {
    ...
    <div class="ad-seitenkopf">
      <div class="ad-titel">
        <a class="ad-zurueck" href="<?= Util::e($datei) ?>">← Alle <?= $istBeitrag ? 'Beiträge' : 'Seiten' ?></a>
      ...
      <div class="ad-aktionen">
        ...
        <?php endif; ?>
        <button class="ad-knopf ad-knopf-voll" type="submit" form="inhaltform">Speichern</button>
      </div>
    </div>

    <form id="inhaltform" method="post" class="ad-zwei">
      <?= Auth::csrfFeld() ?>
      <div>
        <section class="ad-karte"><div class="ad-karte-inhalt">
          ...
          <?php if ($istBeitrag): ?>
            <div class="ad-feld">
              ...
              <div class="ad-tipp">Erscheint in der Übersicht. Leer lassen, um sie aus dem Text zu erzeugen.</div>
            </div>
          <?php endif; ?>
          <div class="ad-feld" style="margin:0">
            <label for="inhalt">Inhalt</label>
            <textarea id="inhalt" name="inhalt" rows="20"><?= Util::e((string) $werte['inhalt']) ?></textarea>
            <div class="ad-tipp">Einfaches HTML: &lt;p&gt;, &lt;h2&gt;, &lt;ul&gt;, &lt;strong&gt;, &lt;a&gt;.
      ...
      <div>
        <section class="ad-karte"><div class="ad-karte-inhalt">
          ...
          <div class="ad-tipp" style="margin-left:25px">Im Shop erst nach dem nächsten Veröffentlichen sichtbar.</div>
        </div></section>

        <?php if ($istBeitrag): ?>
          <section class="ad-karte">
            <div class="ad-karte-kopf"><h2>Beitrag</h2></div>
            <div class="ad-karte-inhalt">
              <div class="ad-feld">
              ...
              <?php if (!empty($werte['sichtbar_seit'])): ?>
                <div class="ad-tipp" style="margin-top:8px">
        ...
        <?php if ($id > 0 && Auth::darf('pflegen')): ?>
          <section class="ad-karte"><div class="ad-karte-inhalt">
            <button class="ad-knopf ad-knopf-rot" type="submit" name="aktion" value="loeschen"
...
<div class="ad-seitenkopf">
  <div class="ad-titel">
    ...
    <div class="ad-untertitel"><?= count($eintraege) ?> Einträge</div>
  </div>
  <div class="ad-aktionen">
    <a class="ad-knopf ad-knopf-voll" href="<?= Util::e($datei) ?>?neu=1"><?= Util::e($einzahl) ?> anlegen</a>
  </div>
</div>

<section class="ad-karte"><div class="ad-karte-inhalt eng">
  <?php if ($eintraege === []): ?>
    <div class="ad-leer">
    ...
    <div class="ad-tabelle-rahmen"><table>
      ...
      <tbody>
        <?php foreach ($eintraege as $eintrag): ?>
          <tr class="ad-klick" style="cursor:pointer" onclick="location='<?= Util::e($datei) ?>?id=<?= (int) $eintrag['id'] ?>'">
            <td>
              <div class="ad-haupt"><?= Util::e((string) $eintrag['titel']) ?></div>
              <?php if ($istBeitrag && (string) $eintrag['anriss'] !== ''): ?>
                <div class="ad-neben"><?= Util::e(Util::kuerzen((string) $eintrag['anriss'], 80)) ?></div>
              <?php endif; ?>
            </td>
            <td class="ad-neben"><?= Util::e((string) $eintrag['handle']) ?></td>
            <td>
              <?php if ((int) $eintrag['sichtbar'] === 1): ?>
                <span class="ad-marke ad-marke-gruen"><i></i>Veröffentlicht</span>
              <?php else: ?>
                <span class="ad-marke"><i></i>Entwurf</span>
              <?php endif; ?>
            </td>
            <td class="ad-neben"><?= Util::e(Util::dt((string) $eintrag['geaendert'], 'd.m.Y')) ?></td>
          </tr>
        <?php endforeach; ?>
      </tbody>
    </table></div>
