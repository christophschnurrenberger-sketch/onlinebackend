...
<form method="post">
  ...
  <div class="ad-feldzeile">
    <div class="ad-feld"><label for="ust_id">Umsatzsteuer-ID</label>
      <input type="text" id="ust_id" name="ust_id" value="<?= Util::e($e('ust_id')) ?>" placeholder="DE000000000"></div>
    <div class="ad-feld"><label for="handelsregister">Handelsregister</label>
      <input type="text" id="handelsregister" name="handelsregister" value="<?= Util::e($e('handelsregister')) ?>"></div>
  </div>
  <div class="ad-feld"><label for="geschaeftsfuehrung">Geschäftsführung</label>
